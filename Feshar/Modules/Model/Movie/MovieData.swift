...
class MovieData {
    let movieNameArray = ["Star Wars: The Last Jedi (3D)", "The Expendables", "John Wick: Chapter 3 – Parabellum"]
    let movieDetailsArray = ["Action | Science fiction - 2h 33m", "Action | Adventure - 1h 53m", "Action | Thriller - 2h 10m"]
    let movieTypeArray = ["IMDB", "IMDB", "IMDB"]
