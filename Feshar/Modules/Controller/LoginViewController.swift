...
//MARK: - Custome UI
extension LoginViewController {
    func displayUILoginButton() {
        loginButton.layer.masksToBounds = false
        loginButton.layer.shadowColor = #colorLiteral(red: 0.9276102185, green: 0.3129869699, blue: 0.2666297853, alpha: 1)
        loginButton.layer.shadowOpacity = 0.4
        loginButton.layer.shadowRadius = 12
        loginButton.layer.shadowOffset = CGSize(width: 0, height: 2)
    }
    
    func displayTextFieldError() {
        animateUsernameTextFieldWhenError()
        animatePasswordTextFieldWhenError()
    }
    
    func displayTextFieldSuccess() {
        displayUsernameTextFieldWhenSuccess()
        displayPasswordTextFieldWhenSuccess()
    }
    
    func animateUsernameTextFieldWhenError() {
        usernameTextField.layer.masksToBounds = false
        usernameTextField.layer.borderWidth = 0.5
        usernameTextField.layer.borderColor = #colorLiteral(red: 0.9276102185, green: 0.3129869699, blue: 0.2666297853, alpha: 1)
        usernameTextField.layer.shadowColor = #colorLiteral(red: 0.9276102185, green: 0.3129869699, blue: 0.2666297853, alpha: 1)
        usernameTextField.layer.shadowOpacity = 0.8
        usernameTextField.layer.shadowOffset = CGSize(width: 0, height: 3)
        usernameTextField.shake(horizantaly: 4, Verticaly: 4)
    }
    
    func animatePasswordTextFieldWhenError() {
        passwordTextField.layer.masksToBounds = false
        passwordTextField.layer.borderWidth = 0.5
        passwordTextField.layer.borderColor = #colorLiteral(red: 0.9276102185, green: 0.3129869699, blue: 0.2666297853, alpha: 1)
        passwordTextField.layer.shadowColor = #colorLiteral(red: 0.9276102185, green: 0.3129869699, blue: 0.2666297853, alpha: 1)
        passwordTextField.layer.shadowOpacity = 0.8
        passwordTextField.layer.shadowOffset = CGSize(width: 0, height: 3)
        passwordTextField.shake(horizantaly: 4, Verticaly: 4)
    }
    
    func displayUsernameTextFieldWhenSuccess() {
        usernameTextField.layer.masksToBounds = false
        usernameTextField.layer.borderWidth = 0.5
        usernameTextField.layer.borderColor = #colorLiteral(red: 0.2745098174, green: 0.6768245962, blue: 0.1411764771, alpha: 1)
        usernameTextField.layer.shadowColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
    }
    
    func displayPasswordTextFieldWhenSuccess() {
        passwordTextField.layer.masksToBounds = false
        passwordTextField.layer.borderWidth = 0.5
        passwordTextField.layer.borderColor = #colorLiteral(red: 0.2745098174, green: 0.6768245962, blue: 0.1411764771, alpha: 1)
        passwordTextField.layer.shadowColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
    }
}
